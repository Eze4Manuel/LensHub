    ...
    <div>
        <div>
          <React.Fragment key={'bottom'}>
           <div className="row">
              <button className='btn red' id='deleteaccountbutton' onClick={toggleDrawer('bottom', true)}> Delete Item </button>
           </div>
...
class DelPass extends React.Component {
  ...
  handleSubmit = e => {
    ...
    e.preventDefault();
    $.ajax({
       url: API_BASE_URL + '/deleteProduct/'+ this.props.product_id,
       method: "POST",
     })
     .done( res => {
