...
export default class Decliner extends React.Component {
  ...
  componentDidMount (){
    ...
    //Fetching Data for Profile Completion
     $.ajax({ url: HEAD_API_BASE_URL + '/getHeadDeclinedProducts/?skip='+ this.state.skip +'&take='+ this.state.take, method: "GET", })
     ...
     .fail( err => { console.log(err) })
       ...
       handleFetchMore = (e) => {
         //Fetching Data for Profile Completion
          ...
          $.ajax({
            url: HEAD_API_BASE_URL + '/getHeadDeclinedProducts/?skip='+ this.state.skip +'&take='+ this.state.take, method: "GET",})
  ...
  render(){
    return (
      <>{(this.state.products.length > 0) ?
        <Declined products= {this.state.products} loader = {this.state.loader} handleFetchMore = {this.handleFetchMore} handleRecheck={this.handleRecheck} /> :
